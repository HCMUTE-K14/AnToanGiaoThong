    ...
    public partial class quanLyLuat : UserControl
    {
        ...
        private void dgvThongTu_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (dgvThongTu.Rows[r].Cells[0].Value != null)
            {
                ...
                txtTenThongTu.Text= dgvThongTu.Rows[r].Cells[1].Value.ToString();
                dateTimePicker1.Text= dgvThongTu.Rows[r].Cells[2].Value.ToString();
                richNoiDung.Text= dgvThongTu.Rows[r].Cells[3].Value.ToString();
            }
        }
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            try
            {
                if (txtMaThongTu.Text.Trim() == "" || txtTenThongTu.Text == ""||richNoiDung.Text.Trim()=="")
                {
                ...
                if (f)
                {
                    bool trangthai = l.ThemThongTu(txtMaThongTu.Text, txtTenThongTu.Text, dateTimePicker1.Value, richNoiDung.Text);
                    if (trangthai)
                    {
                ...
                {
                    bool trangthai = l.CapNhatThongTu(ma, txtTenThongTu.Text, dateTimePicker1.Value, richNoiDung.Text);
                    if (trangthai)
                    {
