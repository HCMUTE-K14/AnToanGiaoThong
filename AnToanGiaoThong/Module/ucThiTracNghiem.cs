...
namespace AnToanGiaoThong.Module
{
    public partial class ucThiTracNghiem : UserControl
    {
        ...
        private void showNoiDungCauHoi(int STT)
        {
            ...
            txtNoiDungCauHoi.AppendText("Câu thứ "+(STT+1)+":"+"\n");
            txtNoiDungCauHoi.AppendText(noidungcauhoi);
            txtNoiDungCauHoi.AppendText("\n\n");
            txtNoiDungCauHoi.AppendText("Đáp án A:"+noidungDA_A+"\n");
            txtNoiDungCauHoi.AppendText("Đáp án B:"+noidungDA_B+"\n");
            txtNoiDungCauHoi.AppendText("Đáp án C:"+noidungDA_C+"\n");
            txtNoiDungCauHoi.AppendText("Đáp án D:"+noidungDA_D+"\n");
        }
