...
namespace bussinessAccessLayer.Admin
{
    ...
    public class Luat
    {
        ...
        {
            string sql = string.Format("select * from tblThongTu");
        ...
        public bool CapNhatThongTu(string mathongtu, string tenthongtu, DateTime ngay, string noidung)
        {
        ...
        {
            string sql = string.Format("select TT, SoDieu, NoiDungDieu from tblChiTietChuong");
            return da.executeQueryDataSet(sql);
        }
